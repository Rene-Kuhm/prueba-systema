...
import { CheckCircle, AlertCircle, UserCheck, Mail, Calendar } from 'lucide-react';
        ...
        <Card className='bg-slate-600 rounded-xl mb-8'>
            <CardHeader>
                <div className="flex justify-between items-center ">
                    <div>
                        <CardTitle className='text-green-400'>Usuarios Pendientes</CardTitle>
                        <CardDescription className='text-white'>
                            Gestiona las solicitudes de nuevos usuarios que requieren aprobación
                        </CardDescription>
                    </div>
